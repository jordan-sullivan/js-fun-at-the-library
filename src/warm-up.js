...
var sequel = title + " ... And the Magic Stuff";
console.log(sequel)
//Harry Potter ...And the Magic Stuff

// Initialize a new variable "isFavorite", and assign it to a boolean value indicating
// if the book you chose is your favorite book or not

var isFavorite = true;
console.log("Is " + sequel + " my favorite book? " + isFavorite)
//Is Harry Potter ...And the Magic Stuff my favorite book? true
...
if (isFavorite == true) {
  ...
  console.log("I recently read the " + sequel + " book.")
}
...
var books = ["The Vanishing Half", "The Buddah and the Badass",
"Okovango and the Gods", "Jack Reacher", "Beginner's Russian"];
console.log(books)
//[
  //'The Vanishing Half',
//  'The Buddah and the Badass',
  //'Okovango and the Gods',
//  'Jack Reacher',
  //"Beginner's Russian"
//]
...
var belowTwoHundred = [1, 2, 3, 5, 66, 78, 67, 65, 34, 23, 12, 22]
belowTwoHundred
